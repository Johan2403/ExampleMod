...
import mods.johan24.examplemod.item.ObsidianiteAppleItem;
import mods.johan24.examplemod.util.enums.ModArmorMaterial;
import mods.johan24.examplemod.util.enums.ModItemTier;
...
public class ModItems {
    ...
    public static final RegistryObject<ArmorItem> OBSIDIANITE_HELMET = ITEMS.register("obsidianite_helmet",
            () -> new ArmorItem(ModArmorMaterial.OBSIDIANITE, EquipmentSlotType.HEAD, new Item.Properties().group(ExampleMod.TAB)));

    public static final RegistryObject<ArmorItem> OBSIDIANITE_CHESTPLATE = ITEMS.register("obsidianite_chestplate",
            () -> new ArmorItem(ModArmorMaterial.OBSIDIANITE, EquipmentSlotType.CHEST, new Item.Properties().group(ExampleMod.TAB)));

    public static final RegistryObject<ArmorItem> OBSIDIANITE_LEGGINGS = ITEMS.register("obsidianite_leggings",
            () -> new ArmorItem(ModArmorMaterial.OBSIDIANITE, EquipmentSlotType.LEGS, new Item.Properties().group(ExampleMod.TAB)));
